...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Answer: Provided an initial condition, inject does some operation
    #         on a member of the collection and returns the result. The
    #         new result is passed to the next operation.
  end
